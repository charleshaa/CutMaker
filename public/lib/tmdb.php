...
###############################################################################################################
	...
	*/
		public function searchMovie($movieTitle){
			...
			return $this->_call("search/movie",$movieTitle,$this->_lang, 'search_type=ngram');
		}//end of searchMovie

	/**
	* Search Person
	* http://api.themoviedb.org/3/search/person?api_keyf&language&query=future
	* @param string  $peopleName
	*/
		public function searchPerson($personName){
			$personName="query=".urlencode($personName);
			return $this->_call("search/person",$personName,$this->_lang, 'search_type=ngram');
		}//end of searchPerson
	...
	*/
		public function getPerson($id){
			return $this->_call("person/".$id,$this->_lang);
		}//end of getPerson
	...
	*/
	 ...
	 * @return string
	 */
		private function _call($action,$text,$lang="",$extraparams=""){
		// # http://api.themoviedb.org/3/movie/11?api_key=XXX
			...
			if(!empty($extraparams)) $url .= '&'.$extraparams;
			//echo "<pre>$url</pre>";
			$ch = curl_init();
