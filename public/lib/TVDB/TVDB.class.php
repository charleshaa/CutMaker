	...
	class TVDB {
		...
		protected static function request($params) {
			...
			switch($params['action']) {
				...
				case 'show_by_id':
					$id = $params['id'];
					$url = self::baseUrl.'data/series/'.$id.'/en.xml';
				...
				case 'get_banners':
					$id = $params['id'];
					$url = self::baseUrl.'data/series/'.$id.'/banners.xml';
					$data = self::fetchData($url);
					return $data;
				break;
				...
				case 'get_cast':
					$id = $params['id'];
					$url = self::baseUrl.'data/series/'.$id.'/actors.xml';
					$data = self::fetchData($url);
					return $data;
				break;
				...
				case 'search_tv_shows':
					...
					$url = self::apiUrl."/GetSeries.php?seriesname=$showName"."&language=en";
					$data = self::fetchData($url);
					return $data;
				break;
                ...
                case 'get_all_episodes':
                    $showId = $params['show_id'];
                    $url = self::baseUrl.'/data/series/'.$showId.'/all/en.xml';
