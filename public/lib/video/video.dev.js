...
vjs.Player.prototype.requestFullScreen = function(){
  ...
  if (requestFullScreen) {
    ...
    //var plop = this.el_[requestFullScreen.requestFn];
...
vjs.SeekBar.prototype.getPercent = function(){
  if( typeof this.player_.options().start != 'undefined'){
    if(this.player_.duration() == (this.player_.options().end - 1)){
      return (this.player_.currentTime() - this.player_.options().start ) / (this.player_.options().end - this.player_.options().start - 2 );
    } else {
      return (this.player_.currentTime() - this.player_.options().start ) / (this.player_.options().end - this.player_.options().start - 1 );
    }
